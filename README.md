...
1. The core features of Node.js and Express and why they are useful. - Node.js and Express combined allow us to run backed servers using JS. This is useful as it allows simple web backends to operate on the same language and the front end app.
1. Understand and explain the use of Middleware. - Middle ware is a way to keep logic/needed coded in one place to use in multiple endpoints
1. The basic principles of the REST architectural style. - Create, read, update, and delete
1. Understand and explain the use of Express Routers. - Routers allow us to keep similar endpoints in one concise locations.
